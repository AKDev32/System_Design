    ...
    public static class StudentBuilder {
        ...
        Student built () {
            ...
            if (student.phone == null) {
                throw new RuntimeException("Phone number don't exists");
            }
            return student;
        }
    }
...
// But allow to stores values of multiple type
// Class is nothing but a map that can allow to store value of different types.
// {
//
//
//
